...
public class ChatActivity extends AppCompatActivity
{
    ...
    private ImageButton SendMessageButton, SendFilesButton, StartGameButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartGameButton.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View view)
                    {
                        Intent GameActivityIntent = new Intent(ChatActivity.this, Game_activity.class);
    ...
    private void IntializeControllers()
    {
        ...
        StartGameButton = (ImageButton) findViewById(R.id.start_game_btn);
